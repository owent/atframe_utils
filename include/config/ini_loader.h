    ...
    namespace config {
        ...
        private:
            ...
            LIBATFRAME_UTILS_API_HEAD_ONLY struct as_helper {
                ...
                UTIL_FORCEINLINE static _Tt convert(const ini_value &val, size_t index) { return string2any(val.as_cpp_string(index)); }
            };
        ...
        public:
            ...
            LIBATFRAME_UTILS_API_HEAD_ONLY void dump_to(const std::string &path, Ty &val, bool is_force = false, size_t index = 0) {
             ...
             * @param index 转储索引，默认是第一个值
             */
            LIBATFRAME_UTILS_API void dump_to(const std::string &path, char *begin, char *end, bool is_force = false, size_t index = 0);

...
namespace util {
    namespace log {
        ...
        public:
            ...
            void operator()(log_wrapper::level_t::type level_id, const char *level, const char *content);

            inline const time_t &getCheckInterval() const { return check_interval_; }
            ...
            inline const bool &getEnableBuffer() const { return enable_buffer_; }
            ...
            inline const size_t &getMaxFileSize() const { return max_file_size_; }
            ...
            inline const size_t &getMaxFileNumber() const { return max_file_number_; }

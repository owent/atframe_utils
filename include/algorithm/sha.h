...
namespace util {
    namespace hash {
        ...
        public:
            ...
            LIBATFRAME_UTILS_API std::string get_output_base64(::util::base64_mode_t::type bt = ::util::base64_mode_t::EN_BMT_STANDARD) const;
            ...
            static LIBATFRAME_UTILS_API std::string hash_to_base64(type t, const void* in, size_t inlen, ::util::base64_mode_t::type bt = ::util::base64_mode_t::EN_BMT_STANDARD);
        private:
            type hash_type_;

...
#include "../Common/CompilerMessage.h"
...
namespace util
{
    namespace mixed_int 
    {
        ...
        namespace detail
        {
            ...
            public:
                static value_type encode(value_type d) {
                    return (d << TYPE_LEFT_BIT) ^ (d >> TYPE_RIGHT_BIT);
                }
            ...
            public:
                ...
                static value_type decode(value_type d) {
                    return (d << TYPE_RIGHT_BIT) ^ (d >> TYPE_LEFT_BIT);
                }
            };

            template<typename TINT>
            class mixed_int: public std::conditional< 
                std::is_unsigned<TINT>::value,
                mixed_unsigned_int<TINT>,
                mixed_signed_int<TINT>
            >::type {
            public:
            ...
            public:
                ...
                friend bool operator==(const TL& l, const self_type& r) { return unwrapper(l) == decode(r.data_); }
                template<typename TR>
                friend bool operator==(const self_type& l, const TR& r) { return decode(l.data_) == unwrapper(r); }

                friend bool operator!=(const self_type& l, const self_type& r) { return !(l == r); }
                template<typename TL>
                friend bool operator!=(const TL& l, const self_type& r) { return !(l == r); }
                template<typename TR>
                friend bool operator!=(const self_type& l, const TR& r) { return !(l == r); }
                ...
                template<typename TL>
                friend bool operator>(const TL& l, const self_type& r) { return r < l; }
                template<typename TR>
                friend bool operator>(const self_type& l, const TR& r) { return r < l; }

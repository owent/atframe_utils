...
#  endif
 ...
 public:
  ...
  inline void store(value_type desired, ::util::lock::memory_order order =
  ...
  inline value_type exchange(value_type desired, ::util::lock::memory_order order =
                                                     ::util::lock::memory_order_seq_cst) volatile UTIL_CONFIG_NOEXCEPT {
    return data_.exchange(desired, order);
  }
  ...
  inline value_type fetch_add(value_type arg, ::util::lock::memory_order order =
                                                  ::util::lock::memory_order_seq_cst) volatile UTIL_CONFIG_NOEXCEPT {
    return data_.fetch_add(arg, order);
  }
  ...
  inline value_type fetch_sub(value_type arg, ::util::lock::memory_order order =
                                                  ::util::lock::memory_order_seq_cst) volatile UTIL_CONFIG_NOEXCEPT {
    return data_.fetch_sub(arg, order);
  }
  ...
  inline value_type fetch_and(value_type arg, ::util::lock::memory_order order =
                                                  ::util::lock::memory_order_seq_cst) volatile UTIL_CONFIG_NOEXCEPT {
    return data_.fetch_and(arg, order);
  }
  ...
  inline value_type fetch_or(value_type arg, ::util::lock::memory_order order =
                                                 ::util::lock::memory_order_seq_cst) volatile UTIL_CONFIG_NOEXCEPT {
    return data_.fetch_or(arg, order);
  }
  ...
  inline value_type fetch_xor(value_type arg, ::util::lock::memory_order order =
                                                  ::util::lock::memory_order_seq_cst) volatile UTIL_CONFIG_NOEXCEPT {
    return data_.fetch_xor(arg, order);
  }
};
...
#  endif
  ...
  inline void store(value_type desired, EXPLICIT_UNUSED_ATTR ::util::lock::memory_order order =
                                            ::util::lock::memory_order_seq_cst) UTIL_CONFIG_NOEXCEPT {
#  ifdef __UTIL_LOCK_ATOMIC_INT_ATOMIC_MSVC
...
#  endif
  ...
  inline value_type load(EXPLICIT_UNUSED_ATTR ::util::lock::memory_order order =
                             ::util::lock::memory_order_seq_cst) const UTIL_CONFIG_NOEXCEPT {
#  ifdef __UTIL_LOCK_ATOMIC_INT_ATOMIC_MSVC
    typedef detail::atomic_msvc_oprs<sizeof(value_type)> int_opr_t;
    typedef typename int_opr_t::opr_t opr_t;
...
#  endif
  ...
  inline value_type load(EXPLICIT_UNUSED_ATTR ::util::lock::memory_order order =
                             ::util::lock::memory_order_seq_cst) const volatile UTIL_CONFIG_NOEXCEPT {
#  ifdef __UTIL_LOCK_ATOMIC_INT_ATOMIC_MSVC
    typedef detail::atomic_msvc_oprs<sizeof(value_type)> int_opr_t;
    typedef typename int_opr_t::opr_t opr_t;
    return static_cast<value_type>(int_opr_t:: or (const_cast<opr_t *>(&data_), static_cast<opr_t>(0), order));
...
#  endif
  ...
  inline bool compare_exchange_weak(
      value_type &expected, value_type desired, EXPLICIT_UNUSED_ATTR ::util::lock::memory_order success,
...
#  endif
  ...
  inline bool compare_exchange_weak(value_type &expected, value_type desired,
                                    EXPLICIT_UNUSED_ATTR ::util::lock::memory_order order =
                                        ::util::lock::memory_order_seq_cst) volatile UTIL_CONFIG_NOEXCEPT {
#  ifdef __UTIL_LOCK_ATOMIC_INT_ATOMIC_MSVC
    typedef detail::atomic_msvc_oprs<sizeof(value_type)> int_opr_t;
    typedef typename int_opr_t::opr_t opr_t;

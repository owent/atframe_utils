...
#ifndef _UTILS_NETWORK_HTTP_CONTENT_TYPE_H_
#define _UTILS_NETWORK_HTTP_CONTENT_TYPE_H_
...
namespace util {
    namespace network {
        namespace http_content_type {
            ...
            int make_content_type(char *dst, size_t dst_sz, main_type mt, const char *subtype, const char *parameter_key[],
                                  const char *parameter_value[], size_t parameter_sz);
        ...
        struct http_request_content_type_t {
            enum type {
        ...
        struct http_response_content_type_t {
            enum type {};
        };
    }
}

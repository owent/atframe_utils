...
#if defined( __has_include ) && (!(defined(UTIL_CONFIG_COMPILER_IS_GNU) && UTIL_CONFIG_COMPILER_IS_GNU) || (__GNUC__ + 0) >= 5)
...
namespace util {
    ...
    public:
        explicit scoped_demangled_name(const char * name) UTIL_CONFIG_NOEXCEPT :
        ...
        scoped_demangled_name(scoped_demangled_name && other): m_p(other.m_p) {
            other.m_p = NULL;
        }
        ...
        const char * get() const UTIL_CONFIG_NOEXCEPT {
            return m_p;
        }
    };

...
#ifndef UTIL_TYPE_TRAITS_IS_UNION_IMPL_H
#define UTIL_TYPE_TRAITS_IS_UNION_IMPL_H
    ...
    namespace type_traits {
        namespace detail {
            ...
            struct _is_union : public
                               ...
                               integral_constant<bool, UTIL_TYPE_TRAITS_IS_UNION(typename remove_cv<T>::type)>
#else
                               false_type
#endif
            {
            ...
            struct _is_union : public
#ifdef UTIL_TYPE_TRAITS_IS_UNION
                               integral_constant<bool, UTIL_TYPE_TRAITS_IS_UNION(T)>
#else
                               false_type
#endif
            {

...
#ifndef UTIL_TYPE_TRAITS_IS_BASE_OF_IMPL_H
#define UTIL_TYPE_TRAITS_IS_BASE_OF_IMPL_H
...
#define UTIL_TYPE_TRAITS_IS_BASE_OF(TB, TC) is_convertible<typename remove_cv<TC>::type *, typename remove_cv<TB>::type *>::value

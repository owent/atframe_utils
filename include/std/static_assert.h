...
#    define STD_STATIC_ASSERT(B)                                                                        \
      typedef ::util::std::static_assert_test<sizeof(::util::std::STATIC_ASSERTION_FAILURE<(bool)(B)>)> \
          std_static_assert_typedef_
#  elif defined(_MSC_VER)
#    define STD_STATIC_ASSERT(B)                                                  \
      typedef ::util::std::static_assert_test<sizeof(                             \
          ::util::std::STATIC_ASSERTION_FAILURE<STD_STATIC_ASSERT_BOOL_CAST(B)>)> \

...
if(WIN32)
    ...
    if (TARGET libuuid)
        EchoWithColor(COLOR YELLOW "-- Dependency(${PROJECT_NAME}): libuuid found.(Target: libuuid)")
        list(APPEND PROJECT_ATFRAME_UTILS_PUBLIC_LINK_NAMES libuuid)
        set (LIBATFRAME_UTILS_ENABLE_UUID TRUE)
    elseif(Libuuid_FOUND)
        EchoWithColor(COLOR YELLOW "-- Dependency(${PROJECT_NAME}): libuuid found.(${Libuuid_INCLUDE_DIRS}:${Libuuid_LIBRARIES})")

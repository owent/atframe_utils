...
set(ATFRAMEWORK_UTILS_TEST_MKTEMP_BACKUP_CMAKE_REQUIRED_LIBRARIES ${CMAKE_REQUIRED_LIBRARIES})
...
set(CMAKE_REQUIRED_LIBRARIES ${ATFRAMEWORK_UTILS_TEST_MKTEMP_BACKUP_CMAKE_REQUIRED_LIBRARIES})
unset(ATFRAMEWORK_UTILS_TEST_MKTEMP_BACKUP_CMAKE_REQUIRED_LIBRARIES)
...
set(ATFRAMEWORK_UTILS_TEST_STD_FORMAT_BACKUP_CMAKE_REQUIRED_LIBRARIES ${CMAKE_REQUIRED_LIBRARIES})
set(CMAKE_REQUIRED_LIBRARIES ${ATFRAMEWORK_CMAKE_TOOLSET_SYSTEM_LINKS})

if(NOT DEFINED ATFRAMEWORK_UTILS_ENABLE_STD_FORMAT AND NOT DEFINED CACHE{ATFRAMEWORK_UTILS_ENABLE_STD_FORMAT})
  check_cxx_source_compiles(
    "
#include <format>
#include <iostream>
...
set(CMAKE_REQUIRED_LIBRARIES ${ATFRAMEWORK_UTILS_TEST_STD_FORMAT_BACKUP_CMAKE_REQUIRED_LIBRARIES})
unset(ATFRAMEWORK_UTILS_TEST_STD_FORMAT_BACKUP_CMAKE_REQUIRED_LIBRARIES)
...
if(NOT ATFRAMEWORK_UTILS_ENABLE_STD_FORMAT)
  ...
  if(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_FMTLIB_LINK_NAME
     AND NOT DEFINED ATFRAMEWORK_UTILS_ENABLE_FMTLIB
     AND NOT DEFINED CACHE{ATFRAMEWORK_UTILS_ENABLE_FMTLIB})
    set(ATFRAMEWORK_UTILS_TEST_FMT_BACKUP_CMAKE_REQUIRED_LIBRARIES ${CMAKE_REQUIRED_LIBRARIES})
...
"
    ...
    set(CMAKE_REQUIRED_LIBRARIES ${ATFRAMEWORK_UTILS_TEST_FMT_BACKUP_CMAKE_REQUIRED_LIBRARIES})
    unset(ATFRAMEWORK_UTILS_TEST_FMT_BACKUP_CMAKE_REQUIRED_LIBRARIES)
...
set(ATFRAMEWORK_UTILS_TEST_UNORDERED_MAP_SET_BACKUP_CMAKE_REQUIRED_LIBRARIES ${CMAKE_REQUIRED_LIBRARIES})
set(CMAKE_REQUIRED_LIBRARIES ${ATFRAMEWORK_CMAKE_TOOLSET_SYSTEM_LINKS})
...
set(CMAKE_REQUIRED_LIBRARIES ${ATFRAMEWORK_UTILS_TEST_UNORDERED_MAP_SET_BACKUP_CMAKE_REQUIRED_LIBRARIES})
unset(ATFRAMEWORK_UTILS_TEST_UNORDERED_MAP_SET_BACKUP_CMAKE_REQUIRED_LIBRARIES)

...
set(CMAKE_REQUIRED_LIBRARIES ${LIBATFRAME_UTILS_TEST_MKTEMP_BACKUP_CMAKE_REQUIRED_LIBRARIES})
unset(LIBATFRAME_UTILS_TEST_MKTEMP_BACKUP_CMAKE_REQUIRED_LIBRARIES)
...
if(NOT CMAKE_CROSSCOMPILING AND UNIX)
  set(LIBATFRAME_UTILS_TEST_SYSLOG_BACKUP_CMAKE_REQUIRED_LIBRARIES ${CMAKE_REQUIRED_LIBRARIES})
  set(CMAKE_REQUIRED_LIBRARIES ${ATFRAMEWORK_CMAKE_TOOLSET_SYSTEM_LINKS})
  ...
  cmake_dependent_option(LOG_SINK_ENABLE_SYSLOG_SUPPORT "Enable syslog sink for log." ON "LIBATFRAME_UTILS_TEST_SYSLOG"
                         OFF)
  set(CMAKE_REQUIRED_LIBRARIES ${LIBATFRAME_UTILS_TEST_SYSLOG_BACKUP_CMAKE_REQUIRED_LIBRARIES})
  unset(LIBATFRAME_UTILS_TEST_SYSLOG_BACKUP_CMAKE_REQUIRED_LIBRARIES)
else()
...
if(NOT DEFINED LIBATFRAME_UTILS_ENABLE_LIBUUID AND NOT DEFINED CACHE{LIBATFRAME_UTILS_ENABLE_LIBUUID})
...
set(LIBATFRAME_UTILS_TEST_STD_FORMAT_BACKUP_CMAKE_REQUIRED_LIBRARIES ${CMAKE_REQUIRED_LIBRARIES})
set(CMAKE_REQUIRED_LIBRARIES ${ATFRAMEWORK_CMAKE_TOOLSET_SYSTEM_LINKS})
...
set(CMAKE_REQUIRED_LIBRARIES ${LIBATFRAME_UTILS_TEST_STD_FORMAT_BACKUP_CMAKE_REQUIRED_LIBRARIES})
unset(LIBATFRAME_UTILS_TEST_STD_FORMAT_BACKUP_CMAKE_REQUIRED_LIBRARIES)
...
set(LIBATFRAME_UTILS_TEST_UNORDERED_MAP_SET_BACKUP_CMAKE_REQUIRED_LIBRARIES ${CMAKE_REQUIRED_LIBRARIES})
set(CMAKE_REQUIRED_LIBRARIES ${ATFRAMEWORK_CMAKE_TOOLSET_SYSTEM_LINKS})

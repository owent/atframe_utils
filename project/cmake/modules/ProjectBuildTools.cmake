...
macro(project_build_tools_append_cmake_inherit_options)
    ...
    if (CMAKE_GENERATOR_TOOLSET)
        list (APPEND ${project_build_tools_append_cmake_inherit_options_OUTVAR} "-T" "${CMAKE_GENERATOR_TOOLSET}")
    endif ()
    ...
    if (MSVC)
        foreach(PROTO_SRC ${ARGN})
            ...
            if (PROTO_SRC_OPTIONS)
                list(APPEND PROTO_SRC_OPTIONS /wd4244 /wd4309)
            else()
                set(PROTO_SRC_OPTIONS /wd4244 /wd4309)
            endif()
            ...
            if (MSVC_VERSION GREATER_EQUAL 1922)
                ...
                list(APPEND PROTO_SRC_OPTIONS /wd5054)
            endif ()

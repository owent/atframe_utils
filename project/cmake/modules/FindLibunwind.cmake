...
if (NOT Libunwind_FOUND)
  ...
  if(NOT EXISTS "${Libunwind_INCLUDE_DIRS}/unwind.h")
  ...
  set(Libunwind_LIBRARIES ${Libunwind_LIBRARY_EXTRA} ${Libunwind_LIBRARY} CACHE FILEPATH "Path of libunwind libraries." FORCE)
...
if(Libunwind_INCLUDE_DIRS AND EXISTS "${Libunwind_INCLUDE_DIRS}/libunwind-common.h")
  ...
  if(Libunwind_VERSION_EXTRA)
    set(Libunwind_VERSION_STRING "${Libunwind_VERSION_MAJOR}.${Libunwind_VERSION_MINOR}.${Libunwind_VERSION_EXTRA}" CACHE STRING "Version of libunwind" FORCE)
  else()
    set(Libunwind_VERSION_STRING "${Libunwind_VERSION_MAJOR}.${Libunwind_VERSION_MINOR}" CACHE STRING "Version of libunwind" FORCE)
  endif()
...
if (Libunwind_FOUND)
  ...
  if (NOT TARGET Libunwind::libunwind)
    ...
    if (Libunwind_LIBRARIES)
      ...
      set_target_properties(Libunwind::libunwind PROPERTIES
        INTERFACE_LINK_LIBRARIES ${Libunwind_LIBRARIES_LOCATION}
      )
      unset(Libunwind_LIBRARIES_LOCATION)
    endif()
    if (Libunwind_LDFLAGS)
      set_target_properties(Libunwind::libunwind PROPERTIES
        INTERFACE_LINK_OPTIONS ${Libunwind_LDFLAGS}
      )
    endif ()
    if (Libunwind_CFLAGS)
      set_target_properties(Libunwind::libunwind PROPERTIES
        INTERFACE_COMPILE_OPTIONS ${Libunwind_CFLAGS}
      )
    endif ()
  endif ()

  mark_as_advanced(Libunwind_FOUND LIBUNWIND_FOUND Libunwind_INCLUDE_DIRS LIBUNWIND_INCLUDE_DIRS Libunwind_LIBRARIES LIBUNWIND_LIBRARIES 
    Libunwind_LIBRARY_DIRS Libunwind_VERSION_STRING Libunwind_HAS_UNW_GETCONTEXT Libunwind_HAS_UNW_INIT_LOCAL)
else()

...
#   Jemalloc_LIBRARYIES     - libraries of jemalloc.
#   Jemalloc_LIBRARYIES_PIC - libraries of jemalloc with pic.
...
find_path(Jemalloc_INCLUDE_DIRS NAMES "jemalloc/jemalloc.h" PATH_SUFFIXES include ${_JEMALLOC_SEARCH_ROOT})
find_library(Jemalloc_LIBRARYIES NAMES ${JEMALLOC_NAMES} PATH_SUFFIXES lib ${_JEMALLOC_SEARCH_ROOT})
find_library(Jemalloc_LIBRARYIES_PIC NAMES ${JEMALLOC_NAMES} PATH_SUFFIXES lib ${_JEMALLOC_SEARCH_ROOT})

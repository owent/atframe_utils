...
if(NOT DEFINED __COMPILER_OPTION_LOADED)
    ...
    if (NOT DEFINED COMPILER_OPTIONS_TEST_STD_COROUTINE)
        ...
        if ( NOT MSVC )
            ...
            if (CMAKE_MSVC_RUNTIME)
                add_compiler_flags_to_var(CMAKE_CXX_FLAGS_DEBUG /${CMAKE_MSVC_RUNTIME}d)
                add_compiler_flags_to_var(CMAKE_CXX_FLAGS_RELEASE /${CMAKE_MSVC_RUNTIME})
                add_compiler_flags_to_var(CMAKE_CXX_FLAGS_RELWITHDEBINFO /${CMAKE_MSVC_RUNTIME})
                add_compiler_flags_to_var(CMAKE_CXX_FLAGS_MINSIZEREL /${CMAKE_MSVC_RUNTIME})
            endif ()

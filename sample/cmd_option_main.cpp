...
class foo {
 public:
  void print_t(LIBATFRAME_UTILS_NAMESPACE_ID::cli::callback_param, std::string &str) {
  ...
  void print(LIBATFRAME_UTILS_NAMESPACE_ID::cli::callback_param par) {
    puts("bt func:");
...
class foo2 : public foo {
  void print(LIBATFRAME_UTILS_NAMESPACE_ID::cli::callback_param, std::string &str) { str = "Hello World! - child"; }
};

void print(LIBATFRAME_UTILS_NAMESPACE_ID::cli::callback_param par, std::string *str) {
...
void print(LIBATFRAME_UTILS_NAMESPACE_ID::cli::callback_param) { puts("do nothing! - free func without parameter\n"); }

void print2(LIBATFRAME_UTILS_NAMESPACE_ID::cli::callback_param par, double d) {
  printf("Free Fun B2 Params Num: %d, d => %lf\n", static_cast<int>(par.get_params_number()), d);
}

void print3(LIBATFRAME_UTILS_NAMESPACE_ID::cli::callback_param par, double d, int i) {
  printf("Free Fun B3 Params Num: %d, i => %d, d => %lf\n", static_cast<int>(par.get_params_number()), i, d);
}

static int complex_bind_func(LIBATFRAME_UTILS_NAMESPACE_ID::cli::callback_param, int i) {
  printf("%d\n", i);
  return 0;
}

static void on_error(LIBATFRAME_UTILS_NAMESPACE_ID::cli::callback_param params) {
  puts("Error:");
...
int cmd_option_sample_main() {
  ...
  LIBATFRAME_UTILS_NAMESPACE_ID::cli::cmd_option::ptr_type cco =
      LIBATFRAME_UTILS_NAMESPACE_ID::cli::cmd_option::create();
  ...
  cco->bind_cmd("-bf1, --bind_func_param1",
                (void (*)(LIBATFRAME_UTILS_NAMESPACE_ID::cli::callback_param, std::string *))print, &str)
  ...
  // 无参数普通函数绑定
  cco->bind_cmd("-bf, --bind_func", (void (*)(LIBATFRAME_UTILS_NAMESPACE_ID::cli::callback_param))print)
  ...
  // 绑定多指令的默认执行函数
  co->bind_cmd("@OnDefault", (void (*)(LIBATFRAME_UTILS_NAMESPACE_ID::cli::callback_param))print);

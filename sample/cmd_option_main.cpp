...
class foo {
 public:
  void print_t(atfw::util::cli::callback_param, std::string &str) {
  ...
  void print(atfw::util::cli::callback_param par) {
    puts("bt func:");
  ...
  void print_t2(atfw::util::cli::callback_param par, int i) {
  ...
  void print_t3(atfw::util::cli::callback_param par, int i, double d) {
...
class foo2 : public foo {
  void print(atfw::util::cli::callback_param, std::string &str) { str = "Hello World! - child"; }
};

void print(atfw::util::cli::callback_param par, std::string *str) {
...
void print(atfw::util::cli::callback_param) { puts("do nothing! - free func without parameter\n"); }

void print2(atfw::util::cli::callback_param par, double d) {
  printf("Free Fun B2 Params Num: %d, d => %lf\n", static_cast<int>(par.get_params_number()), d);
}

void print3(atfw::util::cli::callback_param par, double d, int i) {
  printf("Free Fun B3 Params Num: %d, i => %d, d => %lf\n", static_cast<int>(par.get_params_number()), i, d);
}

static int complex_bind_func(atfw::util::cli::callback_param, int i) {
  printf("%d\n", i);
  return 0;
}

static void on_error(atfw::util::cli::callback_param params) {
  puts("Error:");
  std::stringstream args;
  for (atfw::util::cli::cmd_option_list::cmd_array_type::const_iterator iter = params.get_cmd_array().begin();
  ...
  atfw::util::cli::cmd_option_list::value_type err_msg = params.get("@ErrorMsg");
  printf("Error Command: %s, Error Message: %s\n", args.str().c_str(), err_msg ? err_msg->to_string() : "");
}

int cmd_option_sample_main() {
  atfw::util::cli::cmd_option::ptr_type co = atfw::util::cli::cmd_option::create();
  atfw::util::cli::cmd_option::ptr_type cco = atfw::util::cli::cmd_option::create();
  ...
  // 带参数普通函数绑定(自动类型推断)
  cco->bind_cmd("-bf1, --bind_func_param1", (void (*)(atfw::util::cli::callback_param, std::string *))print, &str)
  ...
  // 无参数普通函数绑定
  cco->bind_cmd("-bf, --bind_func", (void (*)(atfw::util::cli::callback_param))print)
  ...
  // 绑定多指令的默认执行函数
  co->bind_cmd("@OnDefault", (void (*)(atfw::util::cli::callback_param))print);

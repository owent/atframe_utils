...
struct obj_bind0 {
  ...
  void operator()(ATFRAMEWORK_UTILS_NAMESPACE_ID::cli::callback_param par) {
...
struct obj_bind1 {
  ...
  void operator()(ATFRAMEWORK_UTILS_NAMESPACE_ID::cli::callback_param par, int a) {
...
struct obj_bind2 {
  ...
  void operator()(ATFRAMEWORK_UTILS_NAMESPACE_ID::cli::callback_param par, int a, double b) {
...
struct obj_bind3 {
  ...
  void operator()(ATFRAMEWORK_UTILS_NAMESPACE_ID::cli::callback_param par, int a, double b, bool c) {

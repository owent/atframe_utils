...
struct obj_bind0 {
  ...
  void operator()(atfw::util::cli::callback_param par) {
...
struct obj_bind1 {
  ...
  void operator()(atfw::util::cli::callback_param par, int a) {
...
struct obj_bind2 {
  ...
  void operator()(atfw::util::cli::callback_param par, int a, double b) {
...
struct obj_bind3 {
  ...
  void operator()(atfw::util::cli::callback_param par, int a, double b, bool c) {

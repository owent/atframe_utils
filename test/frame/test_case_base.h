...
public:
    ...
    void expand(T&&...) {}
#else
    test_on_start_base(const std::string& n, on_start_func func): name(n), func_(func) {
        register_self();
    }
    ...
    test_on_start_base(const std::string& n, on_start_func func, const std::string& dep1, const std::string& dep2): name(n), func_(func) {
        after.insert(dep1);
        after.insert(dep2);
    ...
    test_on_start_base(const std::string& n, on_start_func func, const std::string& dep1, const std::string& dep2, 
        const std::string& dep3): name(n), func_(func) {
        after.insert(dep1);
        after.insert(dep2);
        after.insert(dep3);
    ...
    test_on_start_base(const std::string& n, on_start_func func, const std::string& dep1, const std::string& dep2, 
        const std::string& dep3, const std::string& dep4): name(n), func_(func) {
        after.insert(dep1);
        after.insert(dep2);
        after.insert(dep3);
        after.insert(dep4);
    ...
    test_on_start_base(const std::string& n, on_start_func func, const std::string& dep1, const std::string& dep2, 
        const std::string& dep3, const std::string& dep4, const std::string& dep5): name(n), func_(func) {
        after.insert(dep1);
        after.insert(dep2);
        after.insert(dep3);
        after.insert(dep4);
...
public:
    ...
    void expand(T&&...) {}
#else
    test_on_exit_base(const std::string& n, on_exit_func func): name(n), func_(func) {
        register_self();
    }
    ...
    test_on_exit_base(const std::string& n, on_exit_func func, const std::string& dep1, const std::string& dep2): name(n), func_(func) {
        before.insert(dep1);
        before.insert(dep2);

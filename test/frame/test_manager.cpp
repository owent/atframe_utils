...
void test_manager::inc_success_counter() {
  detail::test_manager_tls_block_t *block = detail::get_test_manager_tls_block();
  if ATFW_UTIL_LIKELY_CONDITION (nullptr != block && nullptr != block->success_counter_ptr) {
...
void test_manager::inc_failed_counter() {
  detail::test_manager_tls_block_t *block = detail::get_test_manager_tls_block();
  if ATFW_UTIL_LIKELY_CONDITION (nullptr != block && nullptr != block->failed_counter_ptr) {

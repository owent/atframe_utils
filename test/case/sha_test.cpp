...
CASE_TEST(sha, sha1) {
    ...
    for (int i = 0; i < 3; ++ i) {
        std::string hash = util::hash::sha::hash_to_binary(util::hash::sha::EN_ALGORITHM_SHA1, sha1_test_buf[i], sha1_test_buflen[i]);
...
CASE_TEST(sha, sha224) {
    ...
    for (int i = 0; i < 3; ++ i) {
        std::string hash = util::hash::sha::hash_to_binary(util::hash::sha::EN_ALGORITHM_SHA224, sha1_test_buf[i], sha1_test_buflen[i]);
        CASE_EXPECT_EQ(hash, std::string(reinterpret_cast<const char*>(sha1_test_sum[i]), output_length));
...
CASE_TEST(sha, sha256) {
    ...
    for (int i = 0; i < 3; ++ i) {
        std::string hash = util::hash::sha::hash_to_binary(util::hash::sha::EN_ALGORITHM_SHA256, sha1_test_buf[i], sha1_test_buflen[i]);
        CASE_EXPECT_EQ(hash, std::string(reinterpret_cast<const char*>(sha1_test_sum[i]), output_length));
...
CASE_TEST(sha, sha384) {
    ...
    for (int i = 0; i < 3; ++ i) {
        std::string hash = util::hash::sha::hash_to_binary(util::hash::sha::EN_ALGORITHM_SHA384, sha1_test_buf[i], sha1_test_buflen[i]);
        CASE_EXPECT_EQ(hash, std::string(reinterpret_cast<const char*>(sha1_test_sum[i]), output_length));
...
CASE_TEST(sha, sha512) {
    ...
    for (int i = 0; i < 3; ++ i) {
        std::string hash = util::hash::sha::hash_to_binary(util::hash::sha::EN_ALGORITHM_SHA512, sha1_test_buf[i], sha1_test_buflen[i]);
        CASE_EXPECT_EQ(hash, std::string(reinterpret_cast<const char*>(sha1_test_sum[i]), output_length));

...
#include "config/atframe_utils_build_feature.h"
    ...
    (defined(ATFRAMEWORK_UTILS_ENABLE_GSL_WITH_GSL_LITE) && ATFRAMEWORK_UTILS_ENABLE_GSL_WITH_GSL_LITE)
#  define TEST_THIRD_PARTY_GSL 1
#endif

#if (defined(TEST_THIRD_PARTY_GSL) && TEST_THIRD_PARTY_GSL) || \
    (defined(ATFRAMEWORK_UTILS_ENABLE_GSL_WITH_FALLBACK_STL) && ATFRAMEWORK_UTILS_ENABLE_GSL_WITH_FALLBACK_STL)

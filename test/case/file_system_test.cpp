...
CASE_TEST(file_system, dirname) {
    ...
    util::file_system::dirname(__FILE__, 0, dir);
    CASE_MSG_INFO() << "Current dir: " << dir << std::endl;

    util::file_system::dirname(__FILE__, 0, dir, 2);
    CASE_MSG_INFO() << "Test dir: " << dir << std::endl;

    util::file_system::dirname(__FILE__, 0, dir, 3);
...
CASE_TEST(file_system, scan_dir) {
    ...
    util::file_system::scan_dir(dir.c_str(), out, util::file_system::dir_opt_t::EN_DOT_DAFAULT | util::file_system::dir_opt_t::EN_DOT_ABSP |

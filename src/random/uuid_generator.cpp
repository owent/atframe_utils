...
namespace util {
    namespace random {
...
#else
            if (remove_minus) {
                UTIL_STRFUNC_SNPRINTF(str_buff, sizeof(str_buff), "%08x%04x%04x%04x%02x%02x%02x%02x%02x%02x", id.time_low, id.time_mid,
                                    id.time_hi_and_version, id.clock_seq, 
        ...
        LIBATFRAME_UTILS_API std::string uuid_generator::generate_string(bool remove_minus) { return uuid_to_string(generate(), remove_minus); }
        ...
        LIBATFRAME_UTILS_API std::string uuid_generator::generate_string_random(bool remove_minus) { return uuid_to_string(generate_random(), remove_minus); }
        ...
        LIBATFRAME_UTILS_API std::string uuid_generator::generate_string_time(bool remove_minus) { return uuid_to_string(generate_time(), remove_minus); }
    } // namespace random
} // namespace util
